...
class ResultSections extends StatelessWidget {
  const ResultSections({required this.data, super.key});
  final DeductionResult data;

  @override
  Widget build(BuildContext context) => _ServerSections(data: data);
}
